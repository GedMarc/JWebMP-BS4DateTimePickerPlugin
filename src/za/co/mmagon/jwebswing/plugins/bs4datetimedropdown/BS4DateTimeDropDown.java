...
public class BS4DateTimeDropDown extends BSDropDown
{
	
	private static final long serialVersionUID = 1L;
	
	private BS4DateTimePicker datePicker;
	
	private BS4DateTimePickerConfigOptions options;
	
	private String variableName;
	
	public BS4DateTimeDropDown(String variableName)
	{
		setDatePicker(new BS4DateTimePicker(variableName));
	 ...
	 * @return
	 */
	public BS4DateTimePicker getDatePicker()
	{
		if (datePicker == null)
		{
			datePicker = new BS4DateTimePicker("");
		}
		return datePicker;
	}
	 ...
	 * @return
	 */
	public final BS4DateTimeDropDown setDatePicker(BS4DateTimePicker datePicker)
	{
	 ...
	 */
	@Override
	public BS4DateTimePickerConfigOptions getOptions()
	{
		if (options == null)
		{
			this.options = new BS4DateTimePickerConfigOptions();
		}
		return options;
	}
	 ...
	 * @param options
	 */
	public void setOptions(BS4DateTimePickerConfigOptions options)
	{
