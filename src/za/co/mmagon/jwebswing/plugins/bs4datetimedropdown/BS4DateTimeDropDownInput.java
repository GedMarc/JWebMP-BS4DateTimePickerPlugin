...
public class BS4DateTimeDropDownInput
		extends BS4DateTimeDropDown implements BSDropDownMenuChildren
{
	 ...
	 */
	private BS4DateTimeInput inputComponent;
	/**
	 ...
	 */
	public BS4DateTimeDropDownInput(String variableName, String iconClass, BSComponentInputGroupOptions... inputGroupOptions)
	{
		super(variableName);
	 ...
	 * @return
	 */
	public BS4DateTimeInput getInputComponent()
	{
		if (inputComponent == null)
		{
			setInputComponent(new BS4DateTimeInput("YYYY-MMM-DD HH:mm:SS", "dummy.date"));
		}
	 ...
	 */
	public void setInputComponent(BS4DateTimeInput inputComponent)
	{
