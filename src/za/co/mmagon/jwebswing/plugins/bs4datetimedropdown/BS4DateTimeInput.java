...
public class BS4DateTimeInput<J extends BS4DateTimeInput>
		extends BSInput
{
	 ...
	 * @param variableName
	 */
	public BS4DateTimeInput(String dateDisplayFormat, String variableName)
	{
		addAttribute(BS4DateTimeInputAttributes.Date_Time_Input, dateDisplayFormat);
